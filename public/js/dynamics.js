...
(function () {
    ...
    for (k in properties) {
      ...
      if (transformProperties.contains(k)) {
        ...
        if (isSVG && svgProperties.contains(k)) {
          ...
          if (el) el.style[propertyWithPrefix(k)] = v;
        }
      }
    }
  ...
  isSVGElement = function (el) {
    ...
    if (
      ...
      return (_ref =
        (_ref1 = dynamics.tests) != null
          ? typeof _ref1.isSVG === "function"
            ? _ref1.isSVG(el)
            : void 0
          : void 0) != null
        ? _ref
      ...
      for (_i = 0, _len = keys.length; _i < _len; _i++) {
        ...
        if (transformProperties.contains(key)) {
          if (properties["transform"] == null) {
            if (isSVG) {
              matrix = new Matrix2D(
                (_ref = el.transform.baseVal.consolidate()) != null
                  ? _ref.matrix
                  : void 0
              );
            } else {
              matrix = Matrix.fromTransform(
                style[propertyWithPrefix("transform")]
              );
            }
  ...
  InterpolableString = (function () {
    ...
    InterpolableString.prototype.interpolate = function (endInterpolable, t) {
      ...
      newParts = [];
      for (
        i = _i = 0, _ref = Math.min(start.length, end.length);
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
  ...
  DecomposedMatrix2D = (function () {
    ...
    DecomposedMatrix2D.prototype.interpolate = function (endMatrix, t) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        newProps[k] = [];
        for (
          i = _j = 0, _ref1 = this.props[k].length;
          0 <= _ref1 ? _j < _ref1 : _j > _ref1;
          i = 0 <= _ref1 ? ++_j : --_j
        ) {
          newProps[k][i] =
            (endMatrix.props[k][i] - this.props[k][i]) * t + this.props[k][i];
        }
      }
  ...
  Matrix2D = (function () {
    ...
    Matrix2D.prototype.decompose = function () {
      ...
      return new DecomposedMatrix2D({
        ...
        rotate: [
          (Math.atan2(this.m.b, this.m.a) * 180) / Math.PI,
          this.rotateCX,
          this.rotateCY,
        ],
        scale: [kx, ky],
  ...
  DecomposedMatrix = (function () {
    ...
    DecomposedMatrix.prototype.interpolate = function (decomposedB, t, only) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        decomposed[k] = [];
        for (
          i = _j = 0, _ref1 = decomposedA[k].length - 1;
          0 <= _ref1 ? _j <= _ref1 : _j >= _ref1;
          i = 0 <= _ref1 ? ++_j : --_j
        ) {
          if (
            only == null ||
            only.indexOf(k) > -1 ||
            only.indexOf("" + k + ["x", "y", "z"][i]) > -1
          ) {
            decomposed[k][i] =
              (decomposedB[k][i] - decomposedA[k][i]) * t + decomposedA[k][i];
          } else {
  ...
  Matrix = (function () {
    ...
    Matrix.prototype.decompose = function () {
      ...
      if (els[0][3] !== 0 || els[1][3] !== 0 || els[2][3] !== 0) {
        ...
        transposedInversePerspectiveMatrix =
          inversePerspectiveMatrix.transpose();
        perspective =
          transposedInversePerspectiveMatrix.multiply(rightHandSide).els;
      ...
      if (t > 1e-4) {
        ...
        rowElement(0, 0) > rowElement(1, 1) &&
        rowElement(0, 0) > rowElement(2, 2)
      ) {
        s =
          Math.sqrt(
            1.0 + rowElement(0, 0) - rowElement(1, 1) - rowElement(2, 2)
          ) * 2.0;
        x = 0.25 * s;
        ...
        s =
          Math.sqrt(
            1.0 + rowElement(1, 1) - rowElement(0, 0) - rowElement(2, 2)
          ) * 2.0;
        ...
        s =
          Math.sqrt(
            1.0 + rowElement(2, 2) - rowElement(0, 0) - rowElement(1, 1)
          ) * 2.0;
    ...
    Matrix.matrixForTransform = cacheFn(function (transform) {
      ...
      result =
        (_ref =
          (_ref1 = style.transform) != null
            ? _ref1
            : style[propertyWithPrefix("transform")]) != null
          ? _ref
          : (_ref2 = dynamics.tests) != null
          ? _ref2.matrixForTransform(transform)
          : void 0;
    ...
    Matrix.fromTransform = function (transform) {
      ...
      match =
        transform != null
          ? transform.match(/matrix3?d?\(([-0-9,e \.]*)\)/)
          : void 0;
      if (match) {
  ...
  animationTick = function (t, animation) {
    ...
    if (tt >= 1) {
      ...
      for (key in _ref) {
        property = _ref[key];
        properties[key] = interpolate(
          property,
          animation.properties.end[key],
          y
        );
      }
    }
  ...
  observeVisibilityChange(function (visible) {
    ...
    if (!visible) {
      ...
      for (_k = 0, _len2 = timeouts.length; _k < _len2; _k++) {
        timeout = timeouts[_k];
        timeout.delay = leftDelayForTimeout(
          timeBeforeVisibilityChange,
          timeout
        );
        setRealTimeout(timeout);
  ...
  dynamics.easeInOut = function (options) {
    ...
    friction =
      (_ref = options.friction) != null
        ? _ref
        : dynamics.easeInOut.defaults.friction;
  ...
  dynamics.easeIn = function (options) {
    ...
    friction =
      (_ref = options.friction) != null
        ? _ref
        : dynamics.easeIn.defaults.friction;
    return dynamics.bezier({
      points: [
        {
          x: 0,
  ...
  dynamics.easeOut = function (options) {
    ...
    friction =
      (_ref = options.friction) != null
        ? _ref
        : dynamics.easeOut.defaults.friction;
    return dynamics.bezier({
      points: [
        {
          x: 0,
  ...
  dynamics.easeInOut.defaults =
    dynamics.easeIn.defaults =
    dynamics.easeOut.defaults =
      {
        friction: 500,
      };
  ...
  dynamics.stop = makeArrayFn(function (el, options) {
    ...
    if (options.timeout) {
      animationsTimeouts = animationsTimeouts.filter(function (timeout) {
        if (
          timeout.el === el &&
          (options.filter == null || options.filter(timeout))
        ) {
  ...
  dynamics.toggleSlow = function () {
    ...
    return typeof console !== "undefined" && console !== null
      ? typeof console.log === "function"
        ? console.log(
            "dynamics.js: slow animations " + (slow ? "enabled" : "disabled")
          )
        : void 0
      : void 0;
  };
